...
import com.example.lenovo.recitewords.*;
//import com.megawave.android.R;


public class Password_EditText extends android.support.v7.widget.AppCompatEditText implements
    ...
    private void init() {
        ...
        if (mToggleDrawable == null) {
            mToggleDrawable = ContextCompat.getDrawable(getContext(), R.mipmap.eye);
        }
        mToggleDrawable.setBounds(0,0,100,100);
