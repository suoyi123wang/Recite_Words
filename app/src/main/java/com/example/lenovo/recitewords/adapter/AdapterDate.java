...
import com.example.lenovo.recitewords.Util.DateUtil;
import com.example.lenovo.recitewords.Util.OnSignedSuccess;
import com.example.lenovo.recitewords.Util.OnSignedSuccess;
...
public class AdapterDate extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null){
            view = LayoutInflater.from(context).inflate(R.layout.gv,null);
